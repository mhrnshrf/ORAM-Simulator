...
#define L2 18   // upto L2 level buckts have specific Z2 number of slots   (inclusive)  // l24 ->17
#define L3 23   // upto L3 level buckts have specific Z3 number of slots   (inclusive) //  l24 ->22
