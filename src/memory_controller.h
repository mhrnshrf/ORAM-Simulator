...
#define L2 16   // upto L2 level buckts have specific Z2 number of slots   (inclusive)  // l24 ->17
#define L3 19   // upto L3 level buckts have specific Z3 number of slots   (inclusive) //  l24 ->22
...
enum{
  ...
  Z3 = (VOLCANO_ENABLE || STL_ENABLE) ? 3 : (RING_ENABLE && RSTL_ENABLE)? Z-2:Z,   // # slots per bucket upto L3   Z-10
...
static const int LZ[LEVEL] = {Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z, Z3, Z2, Z2, Z2, Z2, Z2, Z2, Z3, Z3, Z3, Z, Z, Z, Z, Z};  // array of different Z for different levels in oram
